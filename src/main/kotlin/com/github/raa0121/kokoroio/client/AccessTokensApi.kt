...
class AccessTokensApi(basePath: kotlin.String = "https://kokoro.io/api") : ApiClient(basePath) {
    ...
    */
    ...
    fun deleteV1AccessTokensAccessTokenId(accessTokenId: kotlin.String) : AccessTokenEntity {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/v1/access_tokens/{access_token_id}".replace("{"+"access_token_id"+"}", "$accessTokenId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<AccessTokenEntity>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as AccessTokenEntity
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getV1AccessTokens() : AccessTokenEntity {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun postV1AccessTokens(name: kotlin.String) : AccessTokenEntity {
