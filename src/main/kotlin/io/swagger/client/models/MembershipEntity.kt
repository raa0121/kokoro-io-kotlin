...
data class MembershipEntity (
    ...
    /* チャンネル情報 */
    val channel: ChannelWithoutMembershipEntity? = null,
    /* 権限 */
    val authority: MembershipEntity.Authority? = null,
    /* 通知をオフにしているか（deprecated: use \"notification_policy\" instead.） */
    val disable_notification: kotlin.Boolean? = null,
    /* 通知ポリシー */
    val notification_policy: MembershipEntity.NotificationPolicy? = null,
    /* 未読メッセージ表示ポリシー */
    val read_state_tracking_policy: MembershipEntity.ReadStateTrackingPolicy? = null,
    /* 一番新しい既読メッセージ */
